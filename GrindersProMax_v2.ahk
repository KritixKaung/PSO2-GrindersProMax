...
Gui, Main:Add, Edit, x180 y72 w40 right number readonly
Gui, Main:Add, UpDown, vTargetMeseta Range0-25, 0
Gui, Main:add, button, x15 y100 w100 h25 vBuyBtn gStartBuying, Start Buying
Gui, Main:add, button, x130 y100 w100 h25 vBreakBtn gBreak, Stop Buying
Gui, Main:add, button, x15 y130 w100 h25 vSellBtn gStartSelling, Start Selling
Gui, Main:add, button, x130 y130 w100 h25 vStopSellingBtn gStopSelling, Stop Selling
Gui, Main:add, button, x10 y160 w110 h25 vStartSellingManuallyBtn gStartSellingManually, Start Selling Manually
Gui, Main:add, button, x130 y160 w110 h25 vStopManualSellBtn gStopManualSell, Stop Manual Selling
Gui, Main:Default
Gui, -sysmenu
gui, Main:show,,Grinders Pro Max v2
...
#WinActivateForce
F1::WinActivate, Grinders Pro Max v2
return
